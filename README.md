...
金融因果知识库。P1-03 抽象原子事件管理、P1-04 抽象因果关系管理和 P1-05 具体案例管理均已完成人工复核；P1-06 局部因果图查询 API 已完成开发并等待人工复核。
...
浏览器打开 <http://127.0.0.1:5173>，首页会进入事件列表。因果关系页为 <http://127.0.0.1:5173/relations>，具体案例页为 <http://127.0.0.1:5173/cases>，系统状态页为 <http://127.0.0.1:5173/system>，API 默认监听 <http://127.0.0.1:3000>。
