...
- [ ] **Step 3: Implement deterministic helpers and element accessibility data**
...
- [ ] **Step 1: Write failing Runtime and Canvas tests**
...
- [ ] **Step 3: Extract styles/production Runtime and implement Canvas behavior**
...
- [ ] **Step 3: Implement inspector components with existing APIs**
...
- [ ] **Step 3: Implement orchestration and 380px workbench CSS**
...
- Create: `tests/e2e/causal-graph-interaction.spec.ts`
- Modify: `README.md`
...
Use fixed seed data and stable Runtime test attributes to verify mouse node/edge selection, adjacency highlighter counts, no initial selection, space open/close, selection switching with panel open/closed, arrow node→relation→node navigation, blank/Escape/close behavior, event and relation content, case link, drag position, direction reset, and set-center URL preserving direction.

- [ ] **Step 2: Run focused E2E and inspect screenshots**

Run: `pnpm exec playwright test tests/e2e/causal-graph-interaction.spec.ts`

Expected: PASS with `node-inspector-1280x720.png` and `relation-inspector-1280x720.png`; no page/console errors.
...
- [ ] **Step 5: Commit and stop for manual review**

```bash
git add apps/web/src/features/causal-graph tests/e2e/causal-graph-interaction.spec.ts README.md docs/stages/phase-1/P1-08-local-graph-interaction-design.md docs/superpowers/plans/2026-07-20-causality-application-roadmap.md docs/superpowers/plans/2026-07-21-p1-08-local-graph-interaction-implementation.md
