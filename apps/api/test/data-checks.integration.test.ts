...
describe.sequential('data-check REST API and rules', () => {
  ...
  it('detects every deterministic rule family inside one rollback-only corruption transaction', async () => {
    ...
    await corruptionClient.query(`
      ...
      values
        ('21000000-0000-4000-8000-000000000001', '11000000-0000-4000-8000-000000000003', '11000000-0000-4000-8000-000000000003', 150, 100, 0, null, now(), now()),
        ('21000000-0000-4000-8000-000000000002', '11000000-0000-4000-8000-000000000003', '11000000-0000-4000-8000-000000000004', 50, 50, 0, '   ', now(), now() - interval '1 day'),
        ('21000000-0000-4000-8000-000000000003', '11000000-0000-4000-8000-000000000003', '11000000-0000-4000-8000-000000000004', 60, 60, 0, null, now(), now()),
        ('21000000-0000-4000-8000-000000000004', '11000000-0000-4000-8000-000000000099', '11000000-0000-4000-8000-000000000004', 50, 50, 0, null, now(), now());
