CREATE TABLE "mcp_access_tokens" (
	...
	CONSTRAINT "mcp_access_tokens_device_name_length_check" CHECK ("mcp_access_tokens"."device_name" = btrim("mcp_access_tokens"."device_name") and char_length("mcp_access_tokens"."device_name") between 1 and 80)
);
